...
var btnn = document.getElementById("buttonPobierzDane");
var wstaw = document.getElementById("wstaw");
...
btnn.addEventListener('click', function (e) {
    ...
    ajax({
        ...
        onSuccess: function (response) {
            var jsonObj = JSON.parse(response);
            wstaw.innerHTML = jsonObj.userId + " " + jsonObj.userName + " " + jsonObj.userURL;
